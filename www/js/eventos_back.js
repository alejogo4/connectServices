...
document.addEventListener("deviceready", onDeviceReady, false);
   ...
   function onDeviceReady(){
	   ...
	   {usuario = "Alberto Pardo Avila";}
		...
		else if(usuario=="armando"){
		usuario = "Jesús Armando López Bolívar";}
		   
		else if(usuario=="uruburu"){
		...
		else if(usuario=="carlosarteaga"){
		usuario = "Juan Carlos Arteaga Cantillo";}
			
		else if(usuario=="luisduran"){
		usuario = "Luis Duran Altamiranda";}
		
		else if(usuario=="luis-vivas"){
		usuario = "Luis Eduardo Vivas Chacon";}	
		
		else if(usuario=="luisquintero"){
		usuario = "Luis Quintero Ortega";}							
		
		else if(usuario=="marlondavid"){
		usuario = "Marlon David Peñuela";}
...
//BARRANQUILLA
var obj1=["JPTB - 003; Juego de pesas de 1g a 5kg con clase M1; certificado DA 3219 y fecha de calibración 2015-03-24."];
var obj2=["LPTB - 005; Juego de pesas de 2mg a 200g  con clase f1; certificado DA 3302 y fecha de calibración 2015-04-24."];
var obj3=["LPTB - 001; Lote de pesas de 20 kg con clase M2; certificado DA 3067 y fecha de calibración 2014-12-01."];
var obj4=["LPTB - 002; Lote de pesa de 10 kg con clase M2; certificado DA 3218 y fecha de calibración 2015-04-30."];
var obj5=["LPTB - 003; Lote de pesa de 5 kg con clase M2; certificado DA 3219 y fecha de calibración 2015-04-30."];

//CARTAGENA
var obj6=["JPTC - 004; Lote de pesas de 1g a 5 kg  con clase M1; certificado DA 3303 y fecha de calibración 2015-06-26."];
var obj7=["JPTC - 005; Lote de pesas de 1mg a 100g  con clase f1; certificado DA 3326 y fecha de calibración 2015-06-16."];
var obj8=["LPTC - 005; Lote de pesas de 20 kg con clase M2; certificado DA 3329 y fecha de calibración 2015-05-11."];
var obj9=["LPTC - 006; Lote de pesas de  5 kg  con clase M2; certificado DA 3363 y fecha de calibración 2015-05-11."];
var obj10=["PIC - 004; Lote de pesas de 10 kg con clase M2; certificado DA 3334 y fecha de calibración 2015-05-11."];


//MEDELLIN
var obj11=["JPTM - 001; Lote de pesas de 1g a 5Kg  con clase F2; certificado DA 3214 y fecha de calibración 2015-04-30."];
var obj12=["JPTM - 002; Lote de pesas de 1mg a 1Kg  con clase f1; certificado DA 3223 y fecha de calibración 2015-05-12."];
var obj13=["JPTM - 007; Lote de pesas de 5 kg - 20kg con clase M1; certificado DA 3122 y fecha de  calibración 2015-02-11."];
var obj14=["PIM - 001; Lote de pesas de 5 kg con clase M1; certificado DA 2956 y fecha de  calibración 2015-01-28."];
var obj15=["PIM - 002; Lote de pesas de  2kg  con clase F1; certificado DA 2955 y fecha de  calibración 2015-01-28."];
var obj16=["LPTM - 002; Lote de pesa de 20 kg con clase m2; certificado DA 3231 y fecha de  calibración 2015-05-16."];
var obj17=["LPTM - 003; Lote de pesa de 10 kg con clase m2; certificado DA 3123 y fecha de  calibración 2015-02-11."];
var obj18=["LPTM - 004; Lote de pesa de 5 kg con clase m2; certificado DA 3092 y fecha de  calibración 2015-02-11."];

//cali
var obj19=["JPTCA - 006; Juego de pesas de 1mg a 2kg  con clase f1; certificado DA 3327 y fecha de  calibración 2015-07-08."];
var obj20=["LPTCA - 001; Lote de pesa de 5 kg con clase m1; certificado DA 3225 y fecha de  calibración 2015-02-03."];
var obj21=["LPTCA - 002; Lote de pesa de 10 kg con clase m2; certificado DA 3126 y fecha de  calibración 2015-02-03."];
var obj22=["LPTCA - 004; Lote de pesa de 20kg con clase m2; certificado DA 3127 y fecha de  calibración 2015-02-04."];

//BOGOTÁ
var obj23=["JPTBO - 001; Juego de pesas de 1g a 500g  con clase f1; certificado DA 3124 y fecha de  calibración 2015-02-12."];
var obj24=["JPTBO - 002; Juego de pesas de 1mg a 500mg  con clase f1; certificado DA 2993 y fecha de  calibración 2015-02-12.."];
var obj25=["LPTM - 002; Lote de pesa de 20 kg con clase m2; certificado DA 3231 y fecha de  calibración 2015-05-16."];
...
var arrayComponente=["a.) Tornillos de Ajuste","b.) Plataforma","c.) Cuchillas","d.) Palancas","e.) Brazo","f.) Regla de Indicación","g.) Seguro o fija brazo","h.) Tornillo Prisionero pilón","i.) Estructura","j.) Tornillería","k.) Pesas Multiplicadoras","i.) Sombrero","m.) Pilón","n.) Columna","ñ.) Ruedas y Eje","o.) Cojinetes","p.) Estribos","q.) Esferas","r.) Pintura","s.) Pilón Corredizo)"];//para la mecanica

var arrayComponente2=["a.)Platinas","b.) Estructura","c.) Topes","d.) Tapa o  bandeja","e.)Patas escualizables o fijas","f.) Tornillería","g.) Calzas","a.) Tarjeta principal","b.) Display","c.) Teclado","d.) Carcaza o tapas","e.) Prensa estopas","f.)  Adaptador/Cable","a.)Cable(s) de celda(s)","b.) Caja de juntas","c.) Tarjeta Sumatoria","d.) Foso","e.) Pintura","f.) Batería"];//para las electronicas

var arrayComponente3=["a.)	Plataforma","b.) Sistema Mecánico","c.) Topes","d.) Barras sensores","e.) Platinas de flexión","f.) Soporte de Celda","g.) Conectores de celda","h.) Caja de Juntas","i.) Tarjeta Principal","j.)Display","k.) Teclado","l.) Carcaza","m.) Prensa Estopas","n.) Cable","ñ.) Cable(s) de Celda(s)","o.) Caja de Juntas","p.) Foso","e.) Pintura","q.) Celdas Hidráulicas","r.) Comunicación Rs 232","s.) Tierras"];//camionera Electronica

var arrayComponente4=["a.) Adaptador / cable","b.) Plato","c.) Portaplato","d.) Carcaza","e.)  Cabina","f.)  Forro de Protección","g.) Teclado","h.)  Nivel","i.) Patas","j.) Tarjeta Principal","k.)  Display","l.)  Conectores","m.)  Celdas","n.) Guias","ñ.) Flexón frontal","o.)  Flexón cortos","p.) Tornillería","q.) Sistema Mecánico","r.) Pesa Interna","s.) Det. De humedad","t.) Sensor de temp.","u.) Resistencia"];//analitica	
...
function cambioEquipo(str){
	  ...
	  if(tipoEquipo == "Bascula Camionera Electronica"){
			...
			$("#informe"+formulario+" .componentes:eq("+b+")").html(arrayComponente3[b]);
			
			}//cierro for var a
		
			
		}else if(tipoEquipo == "Balanza Electronica" || tipoEquipo == "Balanza Analitica" || tipoEquipo == "Balanza Det Humedad" ){
			
			for(var b=0;b<arrayComponente4.length;b++){
			
			$("#informe"+formulario+" .componentes:eq("+b+")").html(arrayComponente4[b]);
			
			}//cierro for var a
			
		}else if(tipoEquipo == "Bascula Electronica" || tipoEquipo == "Bascula (Tipo tanque)" || tipoEquipo == "Bascula (Tipo tolva)" ||                 tipoEquipo == "Bascula (Tipo silo)" || tipoEquipo == "Dinamometro"){
			
			
			for(var b=0;b<arrayComponente2.length;b++){
			
			$("#informe"+formulario+" .componentes:eq("+b+")").html(arrayComponente2[b]);
			
			}//cierro for var a
			
			
		}else if(tipoEquipo == "Bascula Mecanica" || tipoEquipo == "Balanza Mecanica" || tipoEquipo == "Bascula Camionera Mecanica" ||                 tipoEquipo == "Bascula Camionera Electromecanica" || tipoEquipo== "Bascula Electronica(Riel)"){
			
			
			for(var a=0;a<arrayComponente.length;a++){
			
			$("#informe"+formulario+" .componentes:eq("+a+")").html(arrayComponente[a]);
			
			}//cierro for var a
			
		}//cierro if tipoEquipo

	if(tipoEquipo == "Balanza Mecanica" || tipoEquipo == "Bascula Mecanica" || tipoEquipo == "Bascula Camionera Mecanica" || tipoEquipo == "Bascula Electronica(Riel)"){
		
	
		$("#informe"+formulario+" #cuadroNoMecanico").css({display:"none"});
		
		}else if(tipoEquipo == "Balanza Electronica" || tipoEquipo == "Bascula Electronica" || tipoEquipo == "Bascula (Tipo tanque)" || tipoEquipo == "Bascula (Tipo tolva)" || tipoEquipo == "Bascula (Tipo silo)" || tipoEquipo == "Bascula Camionera Electromecanica" || tipoEquipo == "Balanza Analitica" || tipoEquipo == "Balanza Det Humedad"){
...
var mn2=20;	
var maxDs;
	var index = $("#estados"+formulario+" .listasExactitud tr td #cargaExactitud").index(str);
	
	
	
	if(index === 4){
		
		var valor=$("#estados"+formulario+" .listasExactitud tr td #cargaExactitud:eq("+index+")").val();
	...
	console.log("resolucion: "+resolucion +" ds2 : " + maxDs + " totalM: "+totalM);
	var ue=2*(Math.sqrt((Math.pow(resolucion,2))+(Math.pow(resolucion,2))+(Math.pow(maxDs,2))+(Math.pow(totalM,2))) );
...
$(".agregar").click(function(){
	...
	console.log("el valor del identificador:"+identificador);
     ...
     $(".listaEquipos").append('<li class="list" onClick="obtenerIndex(this)"><a href="#datosEquipo'+identificador+'" data-role="button" data-transition="pop" class="datoE ui-btn ui-shadow ui-btn-corner-all ui-btn-up-c btnDatos" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span"> Datos del Equipo</a></li>');
crearEquipo();
crearInforme();
crearProtocolo();	 	 
...
function crearEquipo(){
	...
	$("body").append('<div data-role="page" id="datosEquipo'+identificador+'">');
...
function crearInforme(){
	...
	$("#informe"+identificador).load("informe.html #contenedor",function(){
		...
		var vocales2=["","b","c","d","e","f","g","h","i","j","k","l","m","n","ene","o","p","q","r","s"];
		
		for(var i = 0; i < vocales2.length; i++)
		{
		    for(var l=1; l<7;l++)
			{
			   	var atributo=$("#informe"+identificador+" .basculaMecanica #radio-choice-"+l+vocales2[i]).attr("name");
				$("#informe"+identificador+" .basculaMecanica #radio-choice-"+l+vocales2[i]).attr("name",identificador+atributo);
			}	
		}
...
function trazabilidadF(str){
	...
	if(admitirAgregar){
		...
		$("#datosEquipo"+formulario+" #descripciones").append("<hr>"+objeto[0]);
		arrayOrdinario.push(objeto[2]);
		console.log("arrord"+arrayOrdinario);
		}else{
			
		  
		  console.log(eval(objeto));
...
function guardarEquipo(){
	...
	$("#equipos .listaEquipos li .datoE:eq("+formulario+")").append((formulario+1)+") "+"Datos del Equipo:"+" "+equipo+" "+serie);
	
	$("#equipos .listaEquipos .list:eq("+formulario+") .subitems").remove();
	$("#equipos .listaEquipos .list:eq("+formulario+")").append('<ul class="subitems"><li><a href="#informe'+formulario+'">Informe</a></li><li class="protocolo" onClick="indexFormas(this)"><a href="#estados'+formulario+'"> Protocolo</a></li></ul>');
...
/*	$(".carga").html(medidaEstados);*/
	...
	if(valorEquipo == "Balanza Analitica"){
		...
		for(var i=1;i<=listasRepetibilidad;i++){
			...
			$("#estados"+formulario+" .listasRepetibilidad").append('<tr><th>'+i+'</th><td><input type="text" id="indRepetibilidad" onBlur="resultadoRepetibilidad(this)"></td><td><input type="text" class="resultado2" disabled></td></tr>');
			
			}
			
		for(var k=1;k<=listasRepetibilidad;k++){
		
		$("#estados"+formulario+" .listasRepetibilidad2").append('<tr><td><input type="text" id="indRepetibilidad" onBlur="resultadoRepetibilidad(this)"></td><td><input type="text" class="resultado2" disabled></td></tr>');
...
function capturaCarga(str){
	...
	indexCarga = $("#estados"+formulario+" #repetibilidad .cargaRepetibilidad").index(str);

	valorIndexCarga =$("#estados"+formulario+" #repetibilidad .cargaRepetibilidad:eq("+indexCarga+")").val();
	...
	for(var i=0;i<todosRangos2.length;i++){
		...
		if(valorIndexCarga > todosRangos2[i] && valorIndexCarga <= todosRangos2[(i+1)]){

			valoresCargaRepe.splice(indexCarga,1,$("#datosEquipo"+formulario+" .toleran:eq("+(i)+")").text()); 
...
function resultadoRepetibilidad(str){
	...
	var resindrep;
	var indrep= $("#estados"+formulario+" .listasR:eq("+indexCarga+") #indRepetibilidad").index(str);//es el index
	
	resindrep= $("#estados"+formulario+" .listasR:eq("+indexCarga+") tr td #indRepetibilidad:eq("+indrep+")").val();
	...
	$("#estados"+formulario+" .listasR:eq("+indexCarga+") .resultado2:eq("+indrep+")").val(resindrep.toFixed(decimales));
	...
	if(balanAnalitica){
	 ...
	 for(var i=0;i<=forAnalitica;i++){
		 ...
		 var maxI2 = $("#estados"+formulario+" .listasR:eq("+indexCarga+") .resultado2:eq("+i+")").val();
	...
	console.log("eimax es "+eiMax+" Ei min es "+eiMin+" repe mayor es:"+repeMayor);
	
	repeMayor=0;
	if(indexCarga==0){
		 
		console.log(valoresEiRepe[0]); 
		$("#estados"+formulario+" #maxI2").html(valoresEiRepe[0]);
		$("#estados"+formulario+" #emp2").html(Number(valoresCargaRepe[0]).toFixed((decimales+1)));
		...
		if(valoresEiRepe[0] <= valoresCargaRepe[0]){
			  ...
			  $("#estados"+formulario+" #conformidad2").removeClass('conformidadNo');
			  }else{
			  
			  $("#estados"+formulario+" .mayorOmenor2").html(" > ");	
			  $("#estados"+formulario+" #conformidad2").html("No");
			  $("#estados"+formulario+" #conformidad2").addClass('conformidadNo');
			  $("#estados"+formulario+" #conformidad2").removeClass('conformidadSi');	
			}
		...
		$("#estados"+formulario+" #maxI2b").html(valoresEiRepe[1]);
		$("#estados"+formulario+" #emp2b").html(Number(valoresCargaRepe[1]).toFixed((decimales+1)));
		...
		if(valoresEiRepe[1] <= valoresCargaRepe[1]){
			  ...
			  $("#estados"+formulario+" #conformidad2b").removeClass('conformidadNo');
			  }else{
			  
			  $("#estados"+formulario+" .mayorOmenor2b").html(" > ");	
			  $("#estados"+formulario+" #conformidad2b").html("No");
			  $("#estados"+formulario+" #conformidad2b").addClass('conformidadNo');
			  $("#estados"+formulario+" #conformidad2b").removeClass('conformidadSi');	
			}//cierra else
		...
		if($("#estados"+formulario+" #conformidad2").text() == "Si" && $("#estados"+formulario+" #conformidad2b").text()=="Si"){
...
function numeroFormas(){
	...
	$("#estados"+formulario+" #fotoForma").append("<img src='img/"+numero+".png' width='100%'>");
	
	if(numero == "c2"){
		
		numero=4;
		
		}else if(numero == "t3" || numero == "tms3" || numero == "tbp3" || numero == "riel"){
			
		numero=3;	
			
		}else if(numero == "t4" || numero == "ta4" || numero == "tbp4" || numero == "tlar4"){
	...
	for(var i=1;i <= numero;i++){
		...
		$("#estados"+formulario+" .listasExcentricidad").append("<tr><th>"+i+"</th><td><input type='number' class='indicacion' onBlur='excentricidad(this,"+numero+")'></td><td><input type='text' class='resultado' disabled ></td></tr>");
...
function excentricidad(str,numero){
	...
	for(var i=0;i < numero;i++){
		...
		var indicacion=$("#estados"+formulario+" .indicacion:eq("+i+")").val();
		if(i==0){
			var Ii=indicacion; 
	...
	for(var i=0;i < numero;i++){
		...
		if(i==0){
			var resultado=$("#estados"+formulario+" .resultado:eq("+i+")").val(0);
			}else{
				indicacion=$("#estados"+formulario+" .indicacion:eq("+i+")").val();
				...
				resultado=$("#estados"+formulario+" .resultado:eq("+i+")").val(final.toFixed(decimales));
	...
	for(var k=0;k < numero;k++){
		 ...
		 var valorAbs=Math.abs($("#estados"+formulario+" .resultado:eq("+k+")").val());
...
function obtenerErrorExactitud(str){
	...
	str.value = Number(str.value).toFixed(decimales);
	var indexac= $("#estados"+formulario+" .listasExactitud #indExactitud").index(str);//es el index
	
	var cargaexact = $("#estados"+formulario+" .listasExactitud #cargaExactitud:eq("+indexac+")").val();
	
	var valindexact = $("#estados"+formulario+" .listasExactitud #indExactitud:eq("+indexac+")").val();
	
	var totalres3=valindexact-cargaexact;
	
		
	var valindexact = $("#estados"+formulario+" .listasExactitud .resultado3:eq("+indexac+")").val(totalres3.toFixed(decimalExclusivo2));
	
	 var nueva = 8-indexac;
	
	$("#estados"+formulario+" .listasExactitud #cargaExactitud:eq("+nueva+")").val(cargaexact);
	
	todosRangos2.unshift(0);
	criterioFinal=true;
	for(var i = 0; i <= indexac; i++ ){
		
	 var maxI3 = Math.abs($("#estados"+formulario+" .listasExactitud .resultado3:eq("+i+")").val());	
	 var eMP3 = $("#estados"+formulario+" .listasExactitud #cargaExactitud:eq("+i+")").val();		
			  ...
			  for(var l=0;l<todosRangos2.length;l++){
			      ...
			      eMP3=$("#datosEquipo"+formulario+" .toleran:eq("+(l)+")").text();
...
function cambioTolerancias(str){
	...
	if(str == "OIMLR 76-1"){
	  ...
	  /*alert(contadorRange);	*/ 
	   ...
	   $("#datosEquipo"+formulario+" .clase").html("");		   
		   var capacidad= $("#datosEquipo"+formulario+" #rangos div #capacidadI:eq("+j+")").val();
		   var d=$("#datosEquipo"+formulario+" #rangos div #dI:eq("+j+")").val();
		   var e=$("#datosEquipo"+formulario+" #rangos div #eI:eq("+j+")").val();
		   var clase = capacidad /  e;
		   var unidad = $("#datosEquipo"+formulario+" .medida:eq("+0+")").text();
		   ...
		   if(clase > 100000){
			...
			if(e>=0.1 && unidad=="(g)" || e>=0.0001 && unidad=="(kg)" ){
	   ...
	   for(var p=0;p < todosRangos.length;p++){
		   ...
		   if(p >= 1){
			   ...
			   if(todosRangos[p] > parseInt(todosRangos2[todosRangos2.length-1])){
				...
				$("#datosEquipo"+formulario+" .toleran:eq("+p+")").html(todasTolerancias[p]);
		 ...
		 for(var g=0;g < todosRangos2.length;g++){
			   ...
			   $("#datosEquipo"+formulario+" .listasrangos .rl"+[g]).fadeIn("fast");
		...
		for(var f=0;f < todasTolerancias2.length;f++){
			   ...
			   $("#datosEquipo"+formulario+" .toleran:eq("+(f+1)+")").html(todasTolerancias2[f]);
	...
	if(boleanImg){
		...
		$("#datosEquipo"+formulario+" .clase").html("<img src='img/clase"+identificarImagen+".png'>");
		...
		for(var m=0;m<clases.length;m++){
             ...
             $("#datosEquipo"+formulario+" .clase").append("<img src='img/clase"+clases[m]+".png'>");
	...
	console.log("Capacidades"+capacidades+" "+"las d"+ds+" "+"las e"+eses);
...
function cambieCapMin(str){
	...
	if(str=="OIMLR"){
		...
		$("#datosEquipo"+formulario+" #cuadroClasificacion div").removeClass("ui-disabled");
...
$( "#recibo" ).on( "pageshow", function( event ) {
    ...
    var html='<fieldset id="listPlayers" data-role="controlgroup"><legend><h4>Equipos satisfechos:</h4></legend>';
...
for(p=0;p<5;p++){	
    ...
    var cargas2 = $("#estados"+formulario+" .listasExactitud #cargaExactitud:eq("+p+")").val();
	...
	for(var i=0;i<todosRangos2.length;i++){
		...
		if(cargas2 > todosRangos2[i] && cargas2 <= todosRangos2[(i+1)]){
			...
			arrayTolerancias.splice(p,1,$("#datosEquipo"+formulario+" .toleran:eq("+(i)+")").text()); 
...
var myChart = new JSChart("graph"+formulario, 'line');
    ...
    for(var q=0;q<5;q++){
		...
		var errorRes3 = $("#estados"+formulario+" .listasExactitud .resultado3:eq("+q+")").val();
	...
	for(var l=5;l<9;l++){
		...
		var errorRes32 = $("#estados"+formulario+" .listasExactitud .resultado3:eq("+l+")").val();
...
console.log(arrayErrores+" "+arrayErrores2+" "+arrayTolerancias+" "+cargas);

var setData = myChart.setDataArray([[1,arrayErrores[0]],[2, arrayErrores[1]],[3, arrayErrores[2]],[4, arrayErrores[3]],[5, arrayErrores[4]]], 'blue');

	myChart.setDataArray([[1, arrayErrores2[3]],[2, arrayErrores2[2]],[3, arrayErrores2[1]],[4, arrayErrores2[0]],[5, arrayErrores[4]]], 'green');

if(tipoTolerancia=="Fabricante"){
	var dlFabricante=$("#datosEquipo"+formulario+" #dl").val();
	myChart.setDataArray([[1,Number(dlFabricante)],[2, Number(dlFabricante)],[3,Number(dlFabricante)],[4,Number(dlFabricante)],[5,Number(dlFabricante)]], 'red');
	
	myChart.setDataArray([[1,-dlFabricante],[2,-dlFabricante],[3,-dlFabricante],[4,-dlFabricante],[5,-dlFabricante]], 'reds');
	
	}else{	
	myChart.setDataArray([[1, Number(arrayTolerancias[0])],[2, Number(arrayTolerancias[1])],[3, Number(arrayTolerancias[2])],[4, Number(arrayTolerancias[3])],[5, Number(arrayTolerancias[4])]], 'red');
	
	myChart.setDataArray([[1, Number(-arrayTolerancias[0])],[2, Number(-arrayTolerancias[1])],[3, Number(-arrayTolerancias[2])],[4, Number(-arrayTolerancias[3])],[5, Number(-arrayTolerancias[4])]], 'reds');
	}//cierra else
	...
	for(m=0;m<5;m++){	
    var cargas = $("#estados"+formulario+" .listasExactitud #cargaExactitud:eq("+m+")").val();
...
function ponerColor(numero,str){
	...
	$("#informe"+formulario+" .inicialColor:eq("+Number(numero)+")").html("<span style='color:"+str+";text-shadow: 0px 2px 5px rgba(150, 150, 150, 1);'>"+arrayColores[numero]+"<span>");
	
	$("#informe"+formulario+" .color:eq("+numero+")").css({background:str});
	if(str == "desnudo"){
		
		$("#informe"+formulario+" .color:eq("+numero+")").css({background:"none"});
		$("#informe"+formulario+" .color:eq("+numero+")").html("<h1 style='text-align:center;margin:1px'>*</h1>");
...
function generarTabla(){
	...
	for(var i=1;i<=indicaTabla;i++){
		...
		$("#informe"+formulario+" #numeracion").append("<th class='muere'>"+i+"</th>");
		$("#informe"+formulario+" #inicia1").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		$("#informe"+formulario+" #inicia2").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		$("#informe"+formulario+" #inicia3").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		$("#informe"+formulario+" #inicia4").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		$("#informe"+formulario+" #inicia5").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		$("#informe"+formulario+" #inicia6").append("<th class='muere'><input type='text' class='combinaciones'></th>");
		
		$("#informe"+formulario+" #vcm").append("<th class='muere'><input type='text' onBlur='calculaVoltaje(this,fila1)' class='voltaje combinaciones'></th>");
		$("#informe"+formulario+" #vav").append("<th class='muere'><input type='text' onBlur='calculaVoltaje(this,fila2)' class='voltaje2 combinaciones'></th>");
		$("#informe"+formulario+" #dv").append("<th class='muere'><input type='text' class='delta combinaciones' disabled></th>");
		
		}
	
	
	$("#informe"+formulario+" .combinacion:eq(0)").html(arrayColores[0]+" - "+arrayColores[1]);
	$("#informe"+formulario+" .combinacion:eq(1)").html(arrayColores[0]+" - "+arrayColores[2]);
	$("#informe"+formulario+" .combinacion:eq(2)").html(arrayColores[0]+" - "+arrayColores[3]);
	$("#informe"+formulario+" .combinacion:eq(3)").html(arrayColores[3]+" - "+arrayColores[1]);
	$("#informe"+formulario+" .combinacion:eq(4)").html(arrayColores[3]+" - "+arrayColores[2]);
	$("#informe"+formulario+" .combinacion:eq(5)").html(arrayColores[2]+" - "+arrayColores[1]);
...
function calculaVoltaje(str,fila){
	...
	var voltaje1=$("#informe"+formulario+" .voltaje:eq("+index+")").val();
	var voltaje2=$("#informe"+formulario+" .voltaje2:eq("+index+")").val();
	
	var deltaVol=voltaje1-voltaje2;
	
	$("#informe"+formulario+" .delta:eq("+index+")").val(deltaVol.toFixed(2));
...
$(".sincronizar").click(function(){
	...
	if(estadoConexion=="none"){
		...
		var aleatorioEmpresa= Math.floor(Math.random() * (0-2147483647+1)) + 2147483647;
		...
		var arrayRelleno = [responsable,nomCliente,correoCliente,fecha];
		...
		var arrayCliente = [nitIs,sucursalIs,empresaIs,direccionIs,telefonoIs,ciudadIs];
		
		$.post("http://designscreatives.comuv.com/cargardentro/recuperarDatos2.php",{aleatorioEmpresa:aleatorioEmpresa,arrayCliente:arrayCliente,arrayRelleno:arrayRelleno,img : canvas.toDataURL()},
			function(data){ /*-----*/ });
	    ...
	    for(var fullEquipos=0;fullEquipos <= identificador;fullEquipos++){ 		
			...
			var aleatorioPruebas= Math.floor(Math.random() * (0-2147483647+1)) + 2147483647;
			
			

			//variables del equipo
			var selectedOption = $("#datosEquipo"+fullEquipos+" #equipoI").find('option:selected');
			...
			var codigoInternoI = $("#datosEquipo"+fullEquipos+" .codigoInternoI").val();
			...
			var selectedOption2 = $("#datosEquipo"+fullEquipos+" #tolerancias").find('option:selected');
			...
			var selectedOption3 = $("#datosEquipo"+fullEquipos+" #claseI").find('option:selected');
			...
			var descripciones =$("#datosEquipo"+fullEquipos+" #descripciones").text();
			...
			for(var t=0;t<7;t++)
			{
				var toles=$("#datosEquipo"+fullEquipos+" .toleran:eq("+t+")").text();
				if(toles==""){toles="vacio"}
			...
			var arr=[selectedLabel,nFabricante ,modeloI ,nSerieI ,codigoInternoI ,cap0 ,cap1 ,cap2 ,dI0 ,dI1 ,dI2 ,eI0 ,eI1 ,eI2,selectedLabel2,clase,capMinI ,cero ,rn0 ,rn1 ,rn2 ,rn3 ,rn4 ,rn5 ,r0 ,r1 ,r2 ,r3 ,r4 ,r5 ,r6 ,selectedLabel3 ,capMinEdit ,ds ,dl ,de ,descripciones,ubicacion,nSticker,unidad,tol1,tol2,tol3,tol4,tol5,tol6,tol7];
			...
			var equiposArray=[carga1,selectedLabel3];
			
			
			for(var k=0;k < 10;k++){
				
				var pushIndicacion=$("#estados"+fullEquipos+" .indicacion:eq("+k+")").val();
			...
			for(var k=0;k < 10;k++){
				...
				var pushSubI=$("#estados"+fullEquipos+" .resultado:eq("+k+")").val();
				if(pushSubI==null){
					pushSubI="vacio";
					}
			...
			var carga2a = $("#estados"+fullEquipos+" .cargaRepetibilidad:eq("+0+")").val();
			var carga2b= $("#estados"+fullEquipos+" .cargaRepetibilidad:eq("+1+")").val();
			
			var arrRepe=[carga2a,carga2b];
			
			if(selectedLabel=="Balanza Analítica"){
				
					for(var m=0;m<=19;m++){
					
					var pushIndRep=$("#estados"+fullEquipos+" .listasR #indRepetibilidad:eq("+m+")").val();
				  ...
				  for(var m=0;m<=19;m++){
					...
					var pushErrRep=$("#estados"+fullEquipos+" .listasR .resultado2:eq("+m+")").val();
			...
			arrRepe.push(maxI2a,mayOmen2a,emp2a,conformidad2a,maxI2b,mayOmen2b,emp2b,conformidad2b);
		   ...
		   var arrExac=new Array();
			for(var l =0;l<9;l++){
				...
				var pushCarExa=$("#estados"+fullEquipos+" .listasExactitud #cargaExactitud:eq("+l+")").val();
			...
			for(var l =0;l<9;l++){
				...
				var pushIndExa=$("#estados"+fullEquipos+" .listasExactitud #indExactitud:eq("+l+")").val();
			...
			for(var l =0;l<9;l++){
				...
				var pushResExa=$("#estados"+fullEquipos+" .resultado3:eq("+l+")").val();
		   ...
		   var abecedario=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','ene','o','p','q','r','s'];
		   ...
		   var exactitud=$("#informe"+fullEquipos+" .exactitud").val();
			...
			arrayInforme.push(excentricidad,exactitud);
				...
				for(var i=0;i<abecedario.length;i++){
								...
								if(fullEquipos == 0)
								{
									...
									var valor = $('#informe'+fullEquipos+' input:radio[name='+name+']:checked').val();
								}else{
									
									var name ="radio-choice-"+abecedario[i];
									var valor = $('#informe'+fullEquipos+' input:radio[name='+fullEquipos+name+']:checked').val();
			...
			for(var f=0;f<72;f++){
				...
				if(f<division1)
				{
					...
					var combinaciones=$("#informe"+fullEquipos+" .combinaciones:eq("+countComb+")").val();
					countComb++;
				}else{
					combinaciones="vacio";
					}
			...
			arrayInforme.push(neutro,ftierra,neutroTierra,numCelda,numCables,excitacionMas,excitacionMenos,senalMas,senalMenos,tierra,senseMas,senseMenos,volAlimentacion,volSalida);
			...
			arrayInforme.push(itemm,observaciones,cajaMarca,cajaModelo,cajaAjustePor,cajaTecnologia);
		   ...
		   //
		   //alert("las var")	;
		   //http://designscreatives.comuv.com/cargardentro/recuperarDatos.php
		   /*alert(empresaIs+" "+nitIs+" "+ sucursalIs+" "+arr+equiposArray+arrExac+aleatorioEmpresa+aleatorioPruebas+arrRepe+arrayInforme);*/
		   
		 $.post("http://designscreatives.comuv.com/cargardentro/recuperarDatos.php",{arr:arr,equiposArray:equiposArray,arrExac:arrExac,aleatorioEmpresa:aleatorioEmpresa,aleatorioPruebas:aleatorioPruebas,arrRepe:arrRepe,arrayInforme:arrayInforme,arrayCombinaciones:arrayCombinaciones},
			function(data){
					...
					if(data)
					{
						if(confirmarEnvio)
						{
							...
							navigator.notification.alert(
							  'Los datos se han enviado Con exito', 
							  callBack,  
					...
					$("#preload").html("<h2>El envio ha fallado por favor intentalo de nuevo</h2>");
				...
				function callBack(){navigator.app.exitApp();}
...
function doTable(tx){
	   ...
	   tx.executeSql('CREATE TABLE IF NOT EXISTS DEMO(id INTEGER NOT NULL PRIMARY KEY, aleatorioEmpresa TEXT NOT NULL, arrayCliente TEXT NOT NULL, arrayRelleno TEXT NOT NULL,img TEXT NOT NULL) '); 
	
	   tx.executeSql('CREATE TABLE IF NOT EXISTS DEMO2 (id INTEGER NOT NULL PRIMARY KEY,arr TEXT NOT NULL,equiposArray TEXT NOT NULL,arrExac TEXT NOT NULL,aleatorioEmpresa TEXT NOT NULL,aleatorioPruebas TEXT NOT NULL,arrRepe TEXT NOT NULL,arrayInforme TEXT NOT NULL,arrayCombinaciones TEXT NOT NULL )');
	   
	   //VARIABLES QUE DEBERIAN SER GLOBALES ....
	   ...
	   var aleatorioEmpresa= Math.floor(Math.random() * (0-2147483647+1)) + 2147483647;
		...
		tx.executeSql('INSERT INTO DEMO (aleatorioEmpresa,arrayCliente,arrayRelleno,img) VALUES (?,?,?,?)',[aleatorioEmpresa,arrayCliente,arrayRelleno,canvas.toDataURL()]);
	    ...
	    tx.executeSql('INSERT INTO DEMO2 (arr,equiposArray,arrExac,aleatorioEmpresa,aleatorioPruebas,arrRepe,arrayInforme,arrayCombinaciones) VALUES (?,?,?,?,?,?,?,?)',[arr,equiposArray,arrExac,aleatorioEmpresa,aleatorioPruebas,arrRepe,arrayInforme,arrayCombinaciones]);	
...
function errorCallBack(){
	  alert("Tienes un error pero eres buena persona :)");
	}
...
function verDB(){
	...
	if(activador){
		...
		$("#cuadroDB").animate({
			...
			},400,function(){$("#cuadroDB").css("display","none"); })
...
function querySuccess(tx,result){
	    ...
	    var len = result.rows.length;
		  for(var i = 0; i < len ; i++)
		  {
			  ...
			  $.post("http://designscreatives.comuv.com/cargardentro/recuperarDatos.php",{arr:array,equiposArray:excentricidad,arrExac:exactitud,aleatorioEmpresa:aleatorioEmpresa,aleatorioPruebas:aleatorioPruebas,arrRepe:repetibilidad,arrayInforme:informe,arrayCombinaciones:combinaciones},
			function(data){
...
function querySuccess2(tx,result){
	    ...
	    var len = result.rows.length;
		  for(var i = 0; i < len ; i++)
		  {
			  ...
			  $.post("http://designscreatives.comuv.com/cargardentro/recuperarDatos2.php",{aleatorioEmpresa:aleatorioEmpresa,arrayCliente:cliente,arrayRelleno:relleno,img:row.img },
			function(data){
...
function mostrarInfoDb(tx){
	   ...
	   tx.executeSql('SELECT * FROM DEMO2', [], function(tx,results){
...
/*var array = new Array();
var abecedario=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','ene','o','p','q','r','s','t'];*/
/*var arrayInforme = new Array();
$(".clickme").click(function(){
	...
	for(var fullEquipos=0;fullEquipos <= identificador;fullEquipos++){ 
	   for(var i=0;i<abecedario.length;i++){
		...
		console.log(arrayInforme[0]+" "+arrayInforme[1]+" "+arrayInforme[2]+" "+arrayInforme[3]+" "+arrayInforme[4]+" "+arrayInforme[5]+" "+arrayInforme[6]+" "+arrayInforme[7]+" "+arrayInforme[8]+" "+arrayInforme[9]+" "+arrayInforme[10]);
	arrayInforme.length=0;	
	 }
  })*/
/*var aleatorio = Math.floor(Math.random() * (0-10000000000000000+1)) + 10000000000000000;
alert(aleatorio);*/
